package com.marlondell.workshopmongo.config;
...
import com.marlondell.workshopmongo.dto.AuthorDTO;
import com.marlondell.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu Viagem", "Vou Viajar...Abç", new AuthorDTO(maria));
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Good Morning", "I'm Happy Today", new AuthorDTO(maria));
